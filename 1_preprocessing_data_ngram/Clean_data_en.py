...
en_data=pd.read_csv('datasets/en_data.tsv',delimiter='\t', encoding='utf-8')
...
en_data.to_csv('datasets/clean_en_data_v1.tsv', sep='\t', index=False)
...
en_data.to_csv('datasets/clean_en_data_v2.tsv', sep='\t', index=False)